...
echo "=========================================================="
echo ""
echo "Your LiteLLM Proxy for Amazon Bedrock has been successfully deployed."
echo ""
echo "Next Steps:"
echo "1. Use the API key printed above"
echo "2. Update client_examples/.env with your API_BASE and API_KEY"
echo "3. Test your deployment with: cd client_examples && python openai_http_example.py"
echo ""
